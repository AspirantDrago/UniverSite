...
class FormRegister(FlaskForm):
    ...
    password = PasswordField('Введите пароль (обязательно)', validators=[
        ...
        Regexp(r'^(?=.*?[a-z])(?=.*?[A-Z])(?=.*?[0-9])[a-zA-Z0-9]+$', 0, 'Ошибка. Пароль олжен содержать минимум 1 символ латинского алфавита в верхнем и 1 символ в нижем регистре, а также минимум 1 цифру.')
    ])
